	...
	<div class="container dz-main">
		...
		<div class="row">
			...
			<span id="sp" style="font-style:italic;color:red">${errorMsg}</span>
				<form id="dz_form" class="form-horizontal" action="j_spring_security_check" method="post">
					<div class="form-group">
						<label for="dz-id-1" class="col-xs-2 control-label">UserName</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="j_username" data-rule="required;" name="j_username" value="">
						</div>
						<div class="col-sm-4">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input  class="form-control" id="j_password"  type="password" name="j_password" data-rule="required;" value="">
						</div>
						<div class="col-sm-4">
							<font id="dz_um_alt" color="red"></font>
						</div>
